...
public abstract class Pet {          //추상(abstract) 메소드가 하나라도 존재하면 추상 클래스로 선언해야함
    ...
    //밥먹는 기능
    public abstract void eat();   //메소드 body가 없는 추상적인 형태
                                  //즉, 틀만 제공하고 구체적인 내용 구현은 자식 객체의 오버라이딩에서 구현을 해야함
    ...
    //인사
    //final은 abstract와는 반대로 오버라이딩을 막는다.
